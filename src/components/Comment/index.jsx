  ...
  return (
    <div className="col-lg-4">
      <div className={styles.sectionCommentsWrapperItem}>
        ...
        <div className={styles.sectionCommentsWrapperItemTitle}>
          I can’t recommend this podcast enough
        </div>
        <div className={styles.sectionCommentsWrapperItemAuthor}>
          Betty Lacey
        </div>
      </div>
    </div>
